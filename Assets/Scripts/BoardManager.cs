    ...
    public void MoveAllToLeft()
    {
        ...
        )
        {
            for (
                int x = 1;
                x < size;
                // für jede Spalte außer der Spalte ganz links [1,2,3]
                x++ 
            )
            {
                ...
                if (
                    // Wenn es kein Ziel gibt, wählen Sie das ganz linke
                    targetNode == null 
                )
                {
    ...
    public void MoveAllToUp()
    {
        ...
        )
        {
            for (
                int y = size - 2;
                y >= 0;
                //für jede Zeile außer der obersten [2,1,0]
                y-- 
            )
            {
                var currentNode = GetNodeFromBoard(x, y);
    ...
    public void MoveAllToDown()
    {
        ...
        )
        {
            for (
                int y = 1;
                y < size;
                // für jede Zeile außer der untersten [1,2,3]
                y++ 
            )
            {
                var currentNode = GetNodeFromBoard(x, y);
